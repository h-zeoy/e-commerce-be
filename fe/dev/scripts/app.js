...
/***/ "./src/scripts/controllers/position.controller.js":
/*!********************************************************!*\
  !*** ./src/scripts/controllers/position.controller.js ***!
  \********************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar list = function list(_ref) {\n  var pageNo = _ref.pageNo,\n      pageSize = _ref.pageSize,\n      keywords = _ref.keywords;\n  return $.ajax({\n    url: \"/api/position/list?pageNo=\".concat(pageNo, \"&pageSize=\").concat(pageSize, \"&keywords=\").concat(keywords || ''),\n    headers: {\n      'X-Access-Token': localStorage.getItem('token')\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar listall = function listall(_ref2) {\n  var keywords = _ref2.keywords;\n  return $.ajax({\n    url: \"/api/position/listall?keywords=\".concat(keywords || ''),\n    headers: {\n      'X-Access-Token': localStorage.getItem('token')\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar listone = function listone(id) {\n  return $.ajax({\n    url: '/api/position/listone',\n    data: {\n      id: id\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar lowershelf = function lowershelf(_ref3) {\n  var goodsId = _ref3.goodsId,\n      type = _ref3.type;\n  return $.ajax({\n    url: '/api/position/lowershelf',\n    data: {\n      goodsId: goodsId,\n      type: type\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar uppershelf = function uppershelf(_ref4) {\n  var goodsId = _ref4.goodsId,\n      type = _ref4.type;\n  return $.ajax({\n    url: '/api/position/uppershelf',\n    data: {\n      goodsId: goodsId,\n      type: type\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  list: list,\n  lowershelf: lowershelf,\n  uppershelf: uppershelf,\n  listone: listone,\n  listall: listall\n});\n\n//# sourceURL=webpack:///./src/scripts/models/position.model.js?");
...
eval("module.exports = \"<div class=\\\"box box-info\\\">  <div class=\\\"box-header with-border\\\">    <h3 class=\\\"box-title\\\">商品添加</h3>  </div>  <!-- /.box-header -->  <!-- form start -->  <form class=\\\"form-horizontal\\\" id=\\\"possave\\\" action=\\\"/api/position/save\\\" method=\\\"post\\\" enctype=\\\"multipart/form-data\\\">    <div class=\\\"box-body\\\">      <div class=\\\"form-group\\\">        <label for=\\\"thumbnailUrl\\\" class=\\\"col-sm-2 control-label\\\">商品详情图片</label>        <div class=\\\"col-sm-10 morefile\\\">          <div class=\\\"addMore\\\" id=\\\"add-clone\\\">            <input type=\\\"file\\\" class=\\\"form-control\\\" id=\\\"thumbnailUrl\\\" name=\\\"thumbnailUrl\\\" id=\\\"thumbnailUrl\\\">          </div>        </div>      </div>    </div>      <div class=\\\"form-group\\\">        <label for=\\\"goodsId\\\" class=\\\"col-sm-2 control-label\\\">商品Id</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"goodsId\\\" id=\\\"goodsId\\\" placeholder=\\\"请输入商品Id\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"type\\\" class=\\\"col-sm-2 control-label\\\">商品类型</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"type\\\" id=\\\"type\\\" placeholder=\\\"请输入商品类型\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"name\\\" class=\\\"col-sm-2 control-label\\\">商品名称</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"positionName\\\" id=\\\"positionName\\\" placeholder=\\\"请输入商品名称\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"price\\\" class=\\\"col-sm-2 control-label\\\">商品价格</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"price\\\" id=\\\"price\\\" placeholder=\\\"请输入商品价格\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"linePrice\\\" class=\\\"col-sm-2 control-label\\\">商品的划线价格</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"linePrice\\\" id=\\\"linePrice\\\" placeholder=\\\"请输入划线价格\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"channel\\\" class=\\\"col-sm-2 control-label\\\">商品的渠道</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"linePrice\\\" id=\\\"linePrice\\\" placeholder=\\\"请输入商品的渠道\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"sale_time\\\" class=\\\"col-sm-2 control-label\\\">上架时间</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"sale_time\\\" id=\\\"sale_time\\\" placeholder=\\\"请输入上架时间\\\">        </div>      </div>      <div class=\\\"form-group\\\">          <label>Date range:</label>          <div class=\\\"input-group\\\">            <div class=\\\"input-group-addon\\\">              <i class=\\\"fa fa-calendar\\\"></i>            </div>            <input type=\\\"text\\\" class=\\\"form-control pull-right\\\" id=\\\"reservation\\\">          </div>          <!-- /.input group -->        </div>      <!-- ---------------------------商品详情信息--------------------------------------------------------------- -->      <div class=\\\"form-group\\\">        <label for=\\\"goodsInfo\\\" class=\\\"col-sm-2 control-label\\\">商品的样式</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"goodsInfo\\\" id=\\\"goodsInfo\\\" placeholder=\\\"请输入商品样式\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"detail\\\" class=\\\"col-sm-2 control-label\\\">商品详情</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"detail\\\" id=\\\"detail\\\" placeholder=\\\"请输入商品详情\\\">        </div>      </div>      <div class=\\\"form-group\\\" id=\\\"form-imgUrl\\\">        <label for=\\\"imgUrl\\\" class=\\\"col-sm-2 control-label\\\">商品详情图片</label>        <div class=\\\"col-sm-10 morefile\\\">          <!-- \\\"{{`http://localhost:3000/uploads/${pos.companyLogo}`}}\\\" -->          <div class=\\\"addMore\\\" id=\\\"add-more\\\">            <input type=\\\"file\\\" class=\\\"form-control\\\" name=\\\"imgUrl\\\" multiple id=\\\"imgUrl\\\">          </div>        </div>      </div>    </div>    <!-- /.box-body -->    <div class=\\\"box-footer\\\">      <button type=\\\"button\\\" id=\\\"posback\\\" class=\\\"btn btn-default\\\">返回</button>      <button type=\\\"button\\\" id=\\\"possubmit\\\" class=\\\"btn btn-info pull-right\\\">提交</button>    </div>    <!-- /.box-footer -->  </form></div>\"\n\n//# sourceURL=webpack:///./src/scripts/views/position.save.html?");
...
eval("module.exports = \"<div class=\\\"box box-info\\\">  <div class=\\\"box-header with-border\\\">    <h3 class=\\\"box-title\\\">职位编辑</h3>  </div>  <!-- /.box-header -->  <!-- form start -->  <form class=\\\"form-horizontal\\\" action=\\\"/api/position/update\\\" id=\\\"posupdate\\\" method=\\\"post\\\" enctype=\\\"multipart/form-data\\\">    <div class=\\\"box-body\\\">      <div class=\\\"form-group\\\">        <label for=\\\"companyLogo\\\" class=\\\"col-sm-2 control-label\\\">公司Logo</label>        <div class=\\\"col-sm-10\\\">          <img src=\\\"{{`http://localhost:3000/uploads/${pos.companyLogo}`}}\\\" style=\\\"width:50px;height:50px;\\\" alt=\\\"\\\">          <input type=\\\"file\\\" class=\\\"form-control\\\" name=\\\"companyLogo\\\" id=\\\"companyLogo\\\" placeholder=\\\"请选择公司logo图片\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"companyName\\\" class=\\\"col-sm-2 control-label\\\">公司名称</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" value=\\\"<%- pos.companyName %>\\\" name=\\\"companyName\\\" id=\\\"companyName\\\" placeholder=\\\"请输入公司名称\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"positionName\\\" class=\\\"col-sm-2 control-label\\\">职位名称</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" value=\\\"<%- pos.positionName %>\\\" name=\\\"positionName\\\" id=\\\"positionName\\\" placeholder=\\\"请输入职位名称\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"city\\\" class=\\\"col-sm-2 control-label\\\">工作地点</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" value=\\\"<%- pos.city %>\\\" name=\\\"city\\\" id=\\\"city\\\" placeholder=\\\"请输入工作地点\\\">        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"salary\\\" class=\\\"col-sm-2 control-label\\\">岗位薪资</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" value=\\\"<%- pos.salary %>\\\" name=\\\"salary\\\" id=\\\"salary\\\" placeholder=\\\"请输入岗位薪资\\\">        </div>      </div>    </div>    <!-- /.box-body -->    <div class=\\\"box-footer\\\">      <button type=\\\"button\\\" id=\\\"posback\\\" class=\\\"btn btn-default\\\">返回</button>      <button type=\\\"button\\\" id=\\\"possubmit\\\" class=\\\"btn btn-info pull-right\\\">提交</button>    </div>    <!-- /.box-footer -->    <input type=\\\"hidden\\\" name=\\\"id\\\" id=\\\"id\\\" value=\\\"<%- pos._id %>\\\" />  </form></div>\"\n\n//# sourceURL=webpack:///./src/scripts/views/position.update.html?");
