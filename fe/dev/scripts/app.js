...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _views_body_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./views/body.html */ \"./src/scripts/views/body.html\");\n/* harmony import */ var _views_body_html__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_views_body_html__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./router */ \"./src/scripts/router/index.js\");\n\n\n$('#root').html(_views_body_html__WEBPACK_IMPORTED_MODULE_0___default.a);\n_router__WEBPACK_IMPORTED_MODULE_1__[\"default\"].register();\n\n//# sourceURL=webpack:///./src/scripts/app.js?");

/***/ }),

/***/ "./src/scripts/controllers/goods.controller.js":
/*!*****************************************************!*\
  !*** ./src/scripts/controllers/goods.controller.js ***!
  \*****************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar list = function list(_ref) {\n  var pageNo = _ref.pageNo,\n      pageSize = _ref.pageSize,\n      keywords = _ref.keywords;\n  return $.ajax({\n    url: \"/api/goods/list?pageNo=\".concat(pageNo, \"&pageSize=\").concat(pageSize, \"&keywords=\").concat(keywords || ''),\n    headers: {\n      'X-Access-Token': localStorage.getItem('token')\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar listall = function listall(_ref2) {\n  var keywords = _ref2.keywords;\n  return $.ajax({\n    url: \"/api/goods/listall?keywords=\".concat(keywords || ''),\n    headers: {\n      'X-Access-Token': localStorage.getItem('token')\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar listone = function listone(_ref3) {\n  var goodsId = _ref3.goodsId,\n      type = _ref3.type;\n  return $.ajax({\n    url: '/api/goods/listone',\n    data: {\n      goodsId: goodsId,\n      type: type\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar save = function save(params) {\n  return $.ajax({\n    type: \"POST\",\n    url: '/api/goods/save',\n    dataType: \"json\",\n    data: {\n      params: params\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar lowershelf = function lowershelf(_ref4) {\n  var goodsId = _ref4.goodsId;\n  return $.ajax({\n    url: '/api/goods/lowershelf',\n    data: {\n      goodsId: goodsId\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar uppershelf = function uppershelf(_ref5) {\n  var goodsId = _ref5.goodsId;\n  return $.ajax({\n    url: '/api/goods/uppershelf',\n    data: {\n      goodsId: goodsId\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar cloneupload = function cloneupload(_ref6) {\n  var imgData = _ref6.imgData;\n  return $.ajax({\n    type: \"POST\",\n    url: '/api/qiniu/cloneupload',\n    dataType: \"json\",\n    data: {\n      imgData: imgData\n    },\n    // headers: {\n    //   'X-Access-Token': localStorage.getItem('token')\n    // },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\nvar moreupload = function moreupload(_ref7) {\n  var imgData = _ref7.imgData;\n  return $.ajax({\n    type: \"POST\",\n    url: '/api/qiniu/moreupload',\n    dataType: \"json\",\n    data: {\n      imgData: imgData\n    },\n    success: function success(result) {\n      return result;\n    }\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  list: list,\n  lowershelf: lowershelf,\n  uppershelf: uppershelf,\n  listone: listone,\n  listall: listall,\n  cloneupload: cloneupload,\n  moreupload: moreupload,\n  save: save\n});\n\n//# sourceURL=webpack:///./src/scripts/models/goods.model.js?");

/***/ }),

/***/ "./src/scripts/router/action.js":
/*!**************************************!*\
  !*** ./src/scripts/router/action.js ***!
  \**************************************/
/*! exports provided: ActiveClass, NavLink */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ActiveClass\", function() { return ActiveClass; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"NavLink\", function() { return NavLink; });\nvar ActiveClass = function ActiveClass() {\n  var hash = location.hash;\n  var $a = $('#menu li').has('a');\n  var target;\n\n  switch (hash) {\n    case '':\n    case '#/':\n    case '#/home':\n      target = $a.eq(0);\n      break;\n\n    default:\n      target = $a.eq(1);\n      break;\n  }\n\n  target.addClass('active').siblings().removeClass('active');\n};\n\nvar NavLink = function NavLink(router) {\n  var $a = $('#menu li').has('a');\n  $a.on('click', function () {\n    var to = $(this).attr('to');\n    router.go(to);\n  });\n};\n\n\n\n//# sourceURL=webpack:///./src/scripts/router/action.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var sme_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! sme-router */ \"./node_modules/sme-router/index.js\");\n/* harmony import */ var sme_router__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(sme_router__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _controllers_goods_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../controllers/goods.controller */ \"./src/scripts/controllers/goods.controller.js\");\n/* harmony import */ var _action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./action */ \"./src/scripts/router/action.js\");\n\n\n\n\n\n\nvar register = function register() {\n  var router = new sme_router__WEBPACK_IMPORTED_MODULE_2___default.a('router-view'); // 路由导航链接事件绑定\n\n  Object(_action__WEBPACK_IMPORTED_MODULE_4__[\"NavLink\"])(router); // 路由切换时导航高亮设置\n\n  router.use(function (req) {\n    Object(_action__WEBPACK_IMPORTED_MODULE_4__[\"ActiveClass\"])();\n  });\n  router.route('/goods',\n  /*#__PURE__*/\n  function () {\n    var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(\n    /*#__PURE__*/\n    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(req, res, next) {\n      var _ref2, _ref2$pageNo, pageNo, _ref2$pageSize, pageSize, _ref2$keywords, keywords;\n\n      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _ref2 = req.query || {}, _ref2$pageNo = _ref2.pageNo, pageNo = _ref2$pageNo === void 0 ? 1 : _ref2$pageNo, _ref2$pageSize = _ref2.pageSize, pageSize = _ref2$pageSize === void 0 ? 2 : _ref2$pageSize, _ref2$keywords = _ref2.keywords, keywords = _ref2$keywords === void 0 ? '' : _ref2$keywords;\n              _context.t0 = res;\n              _context.next = 4;\n              return _controllers_goods_controller__WEBPACK_IMPORTED_MODULE_3__[\"default\"].list({\n                pageNo: pageNo,\n                pageSize: pageSize,\n                keywords: keywords,\n                router: router\n              });\n\n            case 4:\n              _context.t1 = _context.sent;\n\n              _context.t0.render.call(_context.t0, _context.t1);\n\n              _controllers_goods_controller__WEBPACK_IMPORTED_MODULE_3__[\"default\"].bindListEvents({\n                router: router,\n                req: req\n              });\n\n            case 7:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee);\n    }));\n\n    return function (_x, _x2, _x3) {\n      return _ref.apply(this, arguments);\n    };\n  }());\n  router.route('/save', function (req, res, next) {\n    res.render(_controllers_goods_controller__WEBPACK_IMPORTED_MODULE_3__[\"default\"].save());\n    $(document).ready(function () {\n      $('#reservationtime').daterangepicker({\n        timePicker: true,\n        //显示时间\n        timePicker24Hour: true,\n        //时间制\n        timePickerSeconds: true,\n        //时间显示到秒\n        startDate: moment().hours(0).minutes(0).seconds(0),\n        //设置开始日期\n        endDate: moment(new Date()),\n        //设置结束器日期\n        maxDate: moment(new Date().setFullYear(new Date().getFullYear() + 1)),\n        //设置最大日期\n        locale: {\n          format: \"YYYY-MM-DD HH:mm:ss\",\n          //设置显示格式\n          applyLabel: '确定',\n          //确定按钮文本\n          cancelLabel: '取消' //取消按钮文本\n\n        }\n      }, function (start, end, label) {\n        $('#reservationtime').html(start.format('YYYY-MM-DD HH:mm:ss') + ' - ' + end.format('YYYY-MM-DD HH:mm:ss'));\n        sessionStorage.setItem(\"saleTime\", start.format('YYYY-MM-DD HH:mm:ss'));\n        sessionStorage.setItem(\"stopSaleTime\", end.format('YYYY-MM-DD HH:mm:ss'));\n      });\n    });\n    _controllers_goods_controller__WEBPACK_IMPORTED_MODULE_3__[\"default\"].bindSaveEvents(router);\n  });\n  router.route('/update',\n  /*#__PURE__*/\n  function () {\n    var _ref3 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(\n    /*#__PURE__*/\n    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(req, res, next) {\n      var _req$params, id, pageNo, _req$query$keywords, keywords;\n\n      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              res.render(positionController.update());\n              _req$params = req.params, id = _req$params.id, pageNo = _req$params.pageNo;\n              _req$query$keywords = req.query.keywords, keywords = _req$query$keywords === void 0 ? '' : _req$query$keywords;\n              _context2.t0 = res;\n              _context2.next = 6;\n              return positionController.update({\n                id: id\n              });\n\n            case 6:\n              _context2.t1 = _context2.sent;\n\n              _context2.t0.render.call(_context2.t0, _context2.t1);\n\n              positionController.bindUpdateEvents({\n                pageNo: pageNo,\n                router: router,\n                keywords: keywords\n              });\n\n            case 9:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, _callee2);\n    }));\n\n    return function (_x4, _x5, _x6) {\n      return _ref3.apply(this, arguments);\n    };\n  }());\n  router.route('*', function (req, res, next) {\n    res.redirect('/home');\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  register: register\n});\n\n//# sourceURL=webpack:///./src/scripts/router/index.js?");

/***/ }),

/***/ "./src/scripts/views/body.html":
/*!*************************************!*\
  !*** ./src/scripts/views/body.html ***!
  \*************************************/
/*! no static exports found */
...
eval("module.exports = \"<div class=\\\"box\\\">    <div class=\\\"box-header with-border\\\">      <h3 class=\\\"box-title\\\">         <button id=\\\"addbtn\\\" class=\\\"btn btn-block btn-success\\\"><span class=\\\"fa fa-plus\\\"></span> 添加</button>      </h3>      <div class=\\\"box-tools\\\">        <div class=\\\"input-group input-group-sm\\\" style=\\\"width: 150px;\\\">          <input type=\\\"text\\\" id=\\\"keywords\\\" value=\\\"{{keywords}}\\\" name=\\\"pos_search\\\" class=\\\"form-control pull-right\\\" placeholder=\\\"搜索\\\">            <div class=\\\"input-group-btn\\\">            <button type=\\\"button\\\" id=\\\"possearch\\\" class=\\\"btn btn-default\\\"><i class=\\\"fa fa-search\\\"></i></button>          </div>        </div>      </div>    </div>    <!-- /.box-header -->    <div class=\\\"box-body\\\">      <table class=\\\"table table-bordered\\\">        <tr>          <th style=\\\"width: 10px\\\">#</th>          <th>商品缩略图</th>          <th>商品编号</th>          <th>商品名称</th>          <th>商品类型</th>          <th>商品价格</th>          <th>商品渠道</th>          <th>售卖状态</th>          <th style=\\\"width: 140px\\\">操作</th>        </tr>          {{each list v i}}          <tr>            <td>{{i+1}}</td>            <td><img width=\\\"50\\\" height=\\\"50\\\" src=\\\"{{v.thumbnailUrl}}\\\" alt=\\\"\\\"></td>            <td>{{v.code}}</td>            <td>{{v.name}}</td>            <td>{{v.type}}</td>            <td>{{v.price}}</td>            <td>{{v.channel}}</td>            {{if v.sale}} <td>售卖中</td> {{else}}<td>已下架</td>{{/if}}            <td>              <button class=\\\"btn btn-sm btn-primary pos-update\\\" posid=\\\"{{v.goodsId}}\\\" type=\\\"{{v.type}}\\\" pageno=\\\"{{pageNo}}\\\" keywords=\\\"{{keywords}}\\\"><span class=\\\"fa fa-edit\\\"></span> 修改</button>              {{if v.sale}}              <button class=\\\"btn btn-sm btn-warning pos-lowerShelf\\\" posid=\\\"{{v.goodsId}}\\\" type=\\\"{{v.type}}\\\" pageno=\\\"{{pageNo}}\\\" pagecount=\\\"{{pageCount}}\\\" pagesize=\\\"{{pageSize}}\\\" keywords=\\\"{{keywords}}\\\" filename=\\\"\\\"></span> 下架</button>              {{else}}              <button class=\\\"btn btn-sm btn-danger pos-upperShelf\\\" posid=\\\"{{v.goodsId}}\\\" type=\\\"{{v.type}}\\\" pageno=\\\"{{pageNo}}\\\" pagecount=\\\"{{pageCount}}\\\" pagesize=\\\"{{pageSize}}\\\" keywords=\\\"{{keywords}}\\\" filename=\\\"\\\"></span> 上架</button>              {{/if}}            </td>          </tr>          {{/each}}          {{if list.length == 0}}          <tr>            <td colspan=\\\"8\\\"> 暂无数据. </td>          </tr>          {{/if}}      </table>    </div>    {{if list.length > 0}}    <div class=\\\"box-footer clearfix\\\">      <ul class=\\\"pagination pagination-sm no-margin pull-right\\\">        <li><a href=\\\"/#/goods?pageNo={{pageNo > 1 ? pageNo-1 : 1}}\\\">&laquo;</a></li>        {{each pageArray v i}}        <li class=\\\"{{(i+1) === pageNo ? \\'active\\' : \\'\\'}}\\\"><a href=\\\"/#/goods?pageNo={{i+1}}&keywords={{keywords}}\\\">{{i+1}}</a></li>        {{/each}}        <li><a href=\\\"/#/goods?pageNo={{pageNo < pageCount ? pageNo + 1 : pageCount}}\\\">&raquo;</a></li>      </ul>    </div>    {{/if}}  </div>  <!-- /.box -->\"\n\n//# sourceURL=webpack:///./src/scripts/views/goods.list.html?");

/***/ }),

/***/ "./src/scripts/views/goods.save.html":
/*!*******************************************!*\
  !*** ./src/scripts/views/goods.save.html ***!
  \*******************************************/
/*! no static exports found */
...
eval("module.exports = \"<div class=\\\"box box-info\\\">    <div class=\\\"box-header with-border\\\">      <h3 class=\\\"box-title\\\">商品添加</h3>    </div>    <!-- /.box-header -->    <!-- form start -->    <form class=\\\"form-horizontal\\\">      <div class=\\\"box-body\\\">        <div class=\\\"form-group\\\" id=\\\"thumbnailUrl-group\\\">          <label for=\\\"thumbnailUrl\\\" class=\\\"col-sm-2 control-label\\\">缩略图</label>          <div class=\\\"col-sm-10 morefile\\\">            <div class=\\\"addMore\\\" id=\\\"add-clone\\\">              <input type=\\\"file\\\" class=\\\"form-control\\\" id=\\\"thumbnailUrl\\\" name=\\\"thumbnailUrl\\\">              <span class=\\\"help-block\\\"></span>            </div>          </div>        </div>        <div class=\\\"form-group\\\" style=\\\"goods: relative;\\\">            <p id=\\\"cloneUpload\\\" style=\\\"width: 80px; goods: absolute;left: 50%;top:0;margin-left: -40px;background: #ccc;text-align: center;color:#fff\\\">点击上传</p>          </div>        </div>        <div class=\\\"form-group\\\">          <label for=\\\"type\\\" class=\\\"col-sm-2 control-label\\\">商品类型</label>          <div class=\\\"col-sm-10\\\">              <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" checked value=\\\"童装\\\" />童装 </label>               <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"母婴\\\" />母婴 </label>               <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"居家\\\" />居家 </label>               <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"美食\\\" />美食 </label>               <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"女装\\\" />女装 </label>               <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"鞋包\\\" />鞋包 </label>               <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"美妆\\\" />美妆 </label>               <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"进口\\\" />进口 </label>           </div>          <span class=\\\"help-block\\\"></span>        </div>        <div class=\\\"form-group\\\">          <label for=\\\"name\\\" class=\\\"col-sm-2 control-label\\\">商品名称</label>            <div class=\\\"col-sm-10\\\">            <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"name\\\" id=\\\"name\\\" placeholder=\\\"请输入商品名称\\\">            <span class=\\\"help-block\\\"></span>          </div>        </div>        <div class=\\\"form-group\\\">          <label for=\\\"price\\\" class=\\\"col-sm-2 control-label\\\">商品价格</label>            <div class=\\\"col-sm-10\\\">            <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"price\\\" id=\\\"price\\\" placeholder=\\\"请输入商品价格\\\">            <span class=\\\"help-block\\\"></span>          </div>        </div>        <div class=\\\"form-group\\\">          <label for=\\\"linePrice\\\" class=\\\"col-sm-2 control-label\\\">商品的划线价格</label>            <div class=\\\"col-sm-10\\\">            <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"linePrice\\\" id=\\\"linePrice\\\" placeholder=\\\"请输入划线价格\\\">            <span class=\\\"help-block\\\"></span>          </div>        </div>        <div class=\\\"form-group\\\">          <label for=\\\"channel\\\" class=\\\"col-sm-2 control-label\\\">商品的渠道</label>          <div class=\\\"col-sm-10\\\">              <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" checked value=\\\"9.9\\\" />9.9 </label>               <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" value=\\\"限时秒杀\\\" />限时秒杀 </label>               <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" value=\\\"新品特惠\\\" />新品特惠 </label>               <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" value=\\\"今日特卖\\\" />今日特卖 </label>           </div>          <span class=\\\"help-block\\\"></span>        </div>        <div class=\\\"form-group\\\">          <label for=\\\"sale_time\\\" class=\\\"col-sm-2 control-label\\\">可售时间</label>          <div class=\\\"input-group\\\" style=\\\"width: 610px; padding: 0 15px 0 15px\\\">            <div class=\\\"input-group-addon\\\">              <i class=\\\"fa fa-clock-o\\\"></i>            </div>            <input type=\\\"text\\\" class=\\\"form-control pull-right\\\" id=\\\"reservationtime\\\">          </div>        </div>        <!-- ---------------------------商品详情信息--------------------------------------------------------------- -->        <div class=\\\"form-group\\\">          <label for=\\\"goodsInfo\\\" class=\\\"col-sm-2 control-label\\\">商品的样式</label>            <div class=\\\"col-sm-10\\\" id=\\\"add-el-input\\\">              <p style=\\\"display: flex\\\">                <input style=\\\"flex: 0.5\\\" type=\\\"button\\\" class=\\\"form-control\\\" name=\\\"add\\\" id=\\\"add-input\\\" value=\\\"添加\\\">                <input style=\\\"flex: 0.5\\\" type=\\\"button\\\" class=\\\"form-control\\\" name=\\\"add\\\" id=\\\"rm-input\\\" value=\\\"删除\\\">              </p>          </div>        </div>        <div class=\\\"form-group\\\">          <label for=\\\"detail\\\" class=\\\"col-sm-2 control-label\\\">商品详情</label>            <div class=\\\"col-sm-10\\\">            <!-- <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"detail\\\" id=\\\"detail\\\" placeholder=\\\"请输入商品详情\\\"> -->            <textarea rows=\\\"4\\\" cols=\\\"80\\\" name=\\\"detail\\\" id=\\\"detail\\\">请填写详情信息</textarea>            <span class=\\\"help-block\\\"></span>          </div>        </div>        <div class=\\\"form-group\\\" id=\\\"form-imgUrl\\\">          <label for=\\\"imgUrl\\\" class=\\\"col-sm-2 control-label\\\">商品详情图片</label>          <div class=\\\"col-sm-10 morefile\\\">            <!-- \\\"{{`http://localhost:3000/uploads/${pos.companyLogo}`}}\\\" -->            <div class=\\\"addMore\\\" id=\\\"add-more\\\">              <input type=\\\"file\\\" class=\\\"form-control\\\" name=\\\"imgUrl\\\" multiple id=\\\"imgUrl\\\">              <span class=\\\"help-block\\\"></span>            </div>          </div>        </div>        <div class=\\\"form-group\\\"  style=\\\"goods: relative;\\\">          <p id=\\\"moreUpload\\\" style=\\\"width: 80px; goods: absolute;left: 50%;top:0;margin-left: -40px;background: #ccc;text-align: center;color:#fff\\\">点击上传</p>        </div>      </div>      <!-- /.box-body -->      <div class=\\\"box-footer\\\">        <button type=\\\"button\\\" id=\\\"posback\\\" class=\\\"btn btn-default\\\">返回</button>        <button type=\\\"button\\\" id=\\\"possubmit\\\" class=\\\"btn btn-info pull-right\\\">提交</button>      </div>      <!-- /.box-footer -->    </form>  </div>    \"\n\n//# sourceURL=webpack:///./src/scripts/views/goods.save.html?");

/***/ }),

/***/ "./src/scripts/views/goods.update.html":
/*!*********************************************!*\
  !*** ./src/scripts/views/goods.update.html ***!
  \*********************************************/
/*! no static exports found */
...
eval("module.exports = \"<div class=\\\"box box-info\\\">  <div class=\\\"box-header with-border\\\">    <h3 class=\\\"box-title\\\">商品添加</h3>  </div>  <!-- /.box-header -->  <!-- form start -->  <form class=\\\"form-horizontal\\\">    <div class=\\\"box-body\\\">      <div class=\\\"form-group\\\" id=\\\"thumbnailUrl-group\\\">        <label for=\\\"thumbnailUrl\\\" class=\\\"col-sm-2 control-label\\\">缩略图</label>        <div class=\\\"col-sm-10 morefile\\\">          <div class=\\\"addMore\\\" id=\\\"add-clone\\\">            <input type=\\\"file\\\" class=\\\"form-control\\\" id=\\\"thumbnailUrl\\\" name=\\\"thumbnailUrl\\\">            <span class=\\\"help-block\\\"></span>          </div>        </div>      </div>      <div class=\\\"form-group\\\" style=\\\"goods: relative;\\\">          <p id=\\\"cloneUpload\\\" style=\\\"width: 80px; goods: absolute;left: 50%;top:0;margin-left: -40px;background: #ccc;text-align: center;color:#fff\\\">点击上传</p>        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"type\\\" class=\\\"col-sm-2 control-label\\\">商品类型</label>        <div class=\\\"col-sm-10\\\">            <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" checked value=\\\"童装\\\" />童装 </label>             <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"母婴\\\" />母婴 </label>             <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"居家\\\" />居家 </label>             <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"美食\\\" />美食 </label>             <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"女装\\\" />女装 </label>             <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"鞋包\\\" />鞋包 </label>             <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"美妆\\\" />美妆 </label>             <label class=\\\"type-label\\\"><input name=\\\"type\\\" type=\\\"radio\\\" value=\\\"进口\\\" />进口 </label>         </div>        <span class=\\\"help-block\\\"></span>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"name\\\" class=\\\"col-sm-2 control-label\\\">商品名称</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"name\\\" id=\\\"name\\\" placeholder=\\\"请输入商品名称\\\">          <span class=\\\"help-block\\\"></span>        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"price\\\" class=\\\"col-sm-2 control-label\\\">商品价格</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"price\\\" id=\\\"price\\\" placeholder=\\\"请输入商品价格\\\">          <span class=\\\"help-block\\\"></span>        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"linePrice\\\" class=\\\"col-sm-2 control-label\\\">商品的划线价格</label>        <div class=\\\"col-sm-10\\\">          <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"linePrice\\\" id=\\\"linePrice\\\" placeholder=\\\"请输入划线价格\\\">          <span class=\\\"help-block\\\"></span>        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"channel\\\" class=\\\"col-sm-2 control-label\\\">商品的渠道</label>        <div class=\\\"col-sm-10\\\">            <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" checked value=\\\"9.9\\\" />9.9 </label>             <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" value=\\\"限时秒杀\\\" />限时秒杀 </label>             <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" value=\\\"新品特惠\\\" />新品特惠 </label>             <label class=\\\"type-label\\\"><input name=\\\"channel\\\" type=\\\"radio\\\" value=\\\"今日特卖\\\" />今日特卖 </label>         </div>        <span class=\\\"help-block\\\"></span>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"sale_time\\\" class=\\\"col-sm-2 control-label\\\">可售时间</label>        <div class=\\\"input-group\\\" style=\\\"width: 610px; padding: 0 15px 0 15px\\\">          <div class=\\\"input-group-addon\\\">            <i class=\\\"fa fa-clock-o\\\"></i>          </div>          <input type=\\\"text\\\" class=\\\"form-control pull-right\\\" id=\\\"reservationtime\\\">        </div>      </div>      <!-- ---------------------------商品详情信息--------------------------------------------------------------- -->      <div class=\\\"form-group\\\">        <label for=\\\"goodsInfo\\\" class=\\\"col-sm-2 control-label\\\">商品的样式</label>        <div class=\\\"col-sm-10\\\" id=\\\"add-el-input\\\">            <p style=\\\"display: flex\\\">              <input style=\\\"flex: 0.5\\\" type=\\\"button\\\" class=\\\"form-control\\\" name=\\\"add\\\" id=\\\"add-input\\\" value=\\\"添加\\\">              <input style=\\\"flex: 0.5\\\" type=\\\"button\\\" class=\\\"form-control\\\" name=\\\"add\\\" id=\\\"rm-input\\\" value=\\\"删除\\\">            </p>        </div>      </div>      <div class=\\\"form-group\\\">        <label for=\\\"detail\\\" class=\\\"col-sm-2 control-label\\\">商品详情</label>        <div class=\\\"col-sm-10\\\">          <!-- <input type=\\\"text\\\" class=\\\"form-control\\\" name=\\\"detail\\\" id=\\\"detail\\\" placeholder=\\\"请输入商品详情\\\"> -->          <textarea rows=\\\"4\\\" cols=\\\"80\\\" name=\\\"detail\\\" id=\\\"detail\\\">请填写详情信息</textarea>          <span class=\\\"help-block\\\"></span>        </div>      </div>      <div class=\\\"form-group\\\" id=\\\"form-imgUrl\\\">        <label for=\\\"imgUrl\\\" class=\\\"col-sm-2 control-label\\\">商品详情图片</label>        <div class=\\\"col-sm-10 morefile\\\">          <!-- \\\"{{`http://localhost:3000/uploads/${pos.companyLogo}`}}\\\" -->          <div class=\\\"addMore\\\" id=\\\"add-more\\\">            <input type=\\\"file\\\" class=\\\"form-control\\\" name=\\\"imgUrl\\\" multiple id=\\\"imgUrl\\\">            <span class=\\\"help-block\\\"></span>          </div>        </div>      </div>      <div class=\\\"form-group\\\"  style=\\\"goods: relative;\\\">        <p id=\\\"moreUpload\\\" style=\\\"width: 80px; goods: absolute;left: 50%;top:0;margin-left: -40px;background: #ccc;text-align: center;color:#fff\\\">点击上传</p>      </div>    </div>    <!-- /.box-body -->    <div class=\\\"box-footer\\\">      <button type=\\\"button\\\" id=\\\"posback\\\" class=\\\"btn btn-default\\\">返回</button>      <button type=\\\"button\\\" id=\\\"possubmit\\\" class=\\\"btn btn-info pull-right\\\">提交</button>    </div>    <!-- /.box-footer -->  </form></div>\"\n\n//# sourceURL=webpack:///./src/scripts/views/goods.update.html?");
